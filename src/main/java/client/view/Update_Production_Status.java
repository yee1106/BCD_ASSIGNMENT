...
public class Update_Production_Status extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(67, 67, 67)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(distributionComboBox, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
  ...
  private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
    if(!isTextFieldEmpty()){
      ReadyShippingDetails readyShippingDetails = new ReadyShippingDetails(examinerTextField.getText(), dateFormat.format(productionDateDateChooser.getDate()), temperatureTextField.getText(), addressTextArea.getText(), current_user.getUserName() ,distributionComboBox.getSelectedItem().toString(), READY_SHIPPING ,dateFormat.format(new Date()));
    String hashUserName = Hasher.hash(current_user.getUserName(), "SHA-256");
     ...
     readyShippingDetails.setDigital_signature(digitalSignature.sign(readyShippingDetails.toString()));
     track_view.updateBlockConfirmOrderTranx(manufacturerHomePage.selectedBlock.getHeader().getBatch_id(), readyShippingDetails, readyShippingDetails.getTo());
     track_view.setUpdateTrackButtonVisible(false);
     track_view.setVisible(true);
     this.setVisible(false);
     track_view.setStatusTrackText(track_view.getStatusTrackText() + "\n" + readyShippingDetails.readyShippingStepTrackToString());
    }
    else{
  ...
  private boolean isTextFieldEmpty(){
    return (examinerTextField.getText().isEmpty() || dateFormat.format(productionDateDateChooser.getDate()).isEmpty() || distributionComboBox.getSelectedItem() == null
             || temperatureTextField.getText().isEmpty() || addressTextArea.getText().isEmpty());
  }
