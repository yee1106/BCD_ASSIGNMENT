...
public class Patient_Vaccination_Record extends javax.swing.JFrame {
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
        if (!isTextFieldEmpty()) {
            if (isReached(Long.parseLong(batchIDTextField.getText()))) {
                if (!isOutOfQuantity(Long.parseLong(batchIDTextField.getText()))) {

                    Patient addPatient = new Patient();
                    for (Patient patient : patient_info) {
                        if (patient.getUserName().equals(icComboBox.getSelectedItem().toString())) {
                            patient.setBatch_id(Long.parseLong(batchIDTextField.getText()));
                    ...
                    try {
                        ...
                        updateBlockConfirmOrderTranx(Long.parseLong(batchIDTextField.getText()), icComboBox.getSelectedItem().toString(), cipherText);
    ...
    private boolean isTextFieldEmpty() {
        return (icComboBox.getSelectedItem() == null || typeVaccineTextField.getText().isBlank() || batchIDTextField.getText().isBlank() || witnessNameTextField.getText().isBlank() || facilityTextArea.getText().isBlank()  || dateFormat.format(dateVaccinatedDateChooser.getDate()).isBlank());
    }
    ...
    public void updateBlockConfirmOrderTranx(long batch_ID, String username, String encryptedPatientDetails) {
    ...
    public void configureAddPatientRecordPage(long batch_id, String typeOfVaccine, int quantity) {
