...
public class Patient_Vaccination_Record extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel3Layout.setVerticalGroup(
      ...
      .addGroup(jPanel3Layout.createSequentialGroup()
        .addComponent(icTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
  ...
  private boolean isTextFieldEmpty(){
    return (icTextField.getText().isBlank() || typeVaccineTextField.getText().isBlank() || batchIDTextField.getText().isBlank() || witnessNameTextField.getText().isBlank() || facilityTextArea.getText().isBlank() || !dateVaccinatedDateChooser.isValid() || dateFormat.format(dateVaccinatedDateChooser.getDate()).isBlank());
  }
